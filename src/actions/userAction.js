...
import{
    ...
    USERLIST_SUCCESS,
    USERLIST_FAILURE,
    //USER_AUTH_SUCCESS, //ad
    //USER_AUTH_FAILURE //ad
   } from '../actions/constants';
   import { SERVERURL } from '../../config';
   //import AsyncStorage from '@react-native-community/async-storage'; //ad
   ...
   export function userLogin(userinfo){
       ...
       return (dispatch) => {
           ...
           axios({
               ...
               if (res.status===200){
                  // const usercredentials = JSON.stringify(res.data); //ad
                  // AsyncStorage.setItem('usercredentials', usercredentials);//ad
